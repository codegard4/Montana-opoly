...
public class PlayerTest {
    ...
    public static void testBuyProperty() {
        ...
        checkTrue(testPlayer.wallet.getProperties().contains(testProperty),
                "testBuyProperty - Property should be in player's wallet");
    ...
    public static void testCannotBuyExpensiveProperty() {
        ...
        checkTrue(testPlayer.wallet.getMoney() == 1500,
                "testCannotBuyExpensiveProperty - Money should remain the same");
        checkFalse(testPlayer.wallet.getProperties().contains(testProperty),
                "testCannotBuyExpensiveProperty - Property should NOT be in wallet");
    ...
    public static void testCannotSellPropertyNotOwned() {
        ...
        checkTrue(seller.wallet.getMoney() == 1500,
                "testCannotSellPropertyNotOwned - Seller's money should not change");
